...
exports.default = (0, server_1.defineSchema)({
    ...
    tasks: (0, server_1.defineTable)({
        ...
        planningQa: values_1.v.optional(values_1.v.array(values_1.v.object({
        ...
        source: values_1.v.optional(values_1.v.union(values_1.v.literal("DASHBOARD"), values_1.v.literal("TELEGRAM"), values_1.v.literal("GITHUB"), values_1.v.literal("AGENT"), values_1.v.literal("API"), values_1.v.literal("TRELLO"), values_1.v.literal("SEED"), values_1.v.literal("MISSION_PROMPT"), values_1.v.literal("PRD_IMPORT"))),
    ...
    // -------------------------------------------------------------------------
    prdDocuments: (0, server_1.defineTable)({
        tenantId: values_1.v.optional(values_1.v.id("tenants")),
        projectId: values_1.v.optional(values_1.v.id("projects")),
        title: values_1.v.string(),
        content: values_1.v.string(),
        taskCount: values_1.v.number(),
        parsedAt: values_1.v.number(),
    ...
    // -------------------------------------------------------------------------
    qcMetrics: (0, server_1.defineTable)({
        projectId: values_1.v.optional(values_1.v.id("projects")),
        environment: values_1.v.optional(values_1.v.union(values_1.v.literal("local"), values_1.v.literal("dev"), values_1.v.literal("staging"), values_1.v.literal("pilot"), values_1.v.literal("production"))),
    ...
    scheduledJobs: (0, server_1.defineTable)({
        ...
        runPolicy: values_1.v.optional(values_1.v.union(values_1.v.literal("standard"), values_1.v.literal("run_if_idle"), values_1.v.literal("run_if_not_run_since"), values_1.v.literal("run_at_least_per_period"), values_1.v.literal("skip_if_last_run_within"))),
    ...
    // -------------------------------------------------------------------------
    quotaSnapshots: (0, server_1.defineTable)({
    ...
    // -------------------------------------------------------------------------
    knowledgeChunks: (0, server_1.defineTable)({
        source: values_1.v.string(),
        title: values_1.v.string(),
        content: values_1.v.string(),
    ...
    knowledgeChatHistory: (0, server_1.defineTable)({
        sessionId: values_1.v.string(),
        role: values_1.v.union(values_1.v.literal("user"), values_1.v.literal("assistant")),
        content: values_1.v.string(),
        sources: values_1.v.optional(values_1.v.array(values_1.v.object({
            title: values_1.v.string(),
            source: values_1.v.string(),
            excerpt: values_1.v.string(),
        }))),
    })
        .index("by_session", ["sessionId"]),
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    gatewayConnection: (0, server_1.defineTable)({
        url: values_1.v.string(),
        updatedAt: values_1.v.number(),
    ...
    // -------------------------------------------------------------------------
    alertRules: (0, server_1.defineTable)({
        projectId: values_1.v.optional(values_1.v.id("projects")),
        type: values_1.v.union(values_1.v.literal("daily_cost_exceeded")),
        threshold: values_1.v.number(),
        params: values_1.v.optional(values_1.v.any()),
        enabled: values_1.v.boolean(),
        createdAt: values_1.v.number(),
        updatedAt: values_1.v.number(),
    })
