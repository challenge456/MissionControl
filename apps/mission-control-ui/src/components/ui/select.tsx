...
>(({ className, children, position = "popper", ...props }, ref) => {
  const resolvedPosition: "item-aligned" | "popper" =
    position === "item-aligned" ? "item-aligned" : "popper"
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("px-3 py-2 text-[10px] font-semibold uppercase tracking-[0.18em] text-muted-foreground", className)}
    {...props}
  />
))
...
>(({ className, children, value, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    value={value}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-2xl py-2 pl-9 pr-3 text-sm outline-none focus:bg-cyan-400/8 focus:text-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
    )}
    {...props}
  >
