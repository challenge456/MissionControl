        ...
        <>
          ...
          <div className="mt-4 rounded-lg border border-[var(--panel-line)] bg-background/30 px-3 py-2">
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              {detail.verificationAdvisory?.checks.length
                ? `${detail.verificationAdvisory.checks.length} evidence-required checks were influenced by memory. They do not satisfy acceptance criteria.`
