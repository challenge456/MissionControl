    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[1000]" onClick={onClose}>
      <div className="bg-card border border-border rounded-xl w-[min(680px,95vw)] max-h-[85vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex justify-between items-center px-6 pt-5">
          ...
          <button className="bg-transparent border-none text-muted-foreground text-2xl cursor-pointer px-2 py-1 leading-none hover:text-foreground transition-colors" onClick={onClose}>
            &times;
          </button>
        </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex justify-between items-start gap-4">
                ...
                <label className="flex items-center gap-2 cursor-pointer whitespace-nowrap shrink-0">
                  ...
                  />
                  <span className="text-[0.8125rem] text-muted-foreground">Custom</span>
                </label>
              </div>
