    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[1000]" onClick={onClose}>
      <div className="bg-surface-3 border border-line rounded-xl shadow-[var(--shadow-elevation-2)] w-[min(680px,95vw)] max-h-[85vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex justify-between items-center px-6 pt-5">
          <h2 className="text-[19px] font-semibold text-ink">Edit Member</h2>
          <button className="bg-transparent border-none text-ink-muted text-2xl cursor-pointer px-2 py-1 leading-none hover:text-ink transition-colors duration-150" onClick={onClose}>
            &times;
          </button>
        </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex justify-between items-start gap-4">
                ...
                <label className="flex items-center gap-2 cursor-pointer whitespace-nowrap shrink-0">
                  ...
                  />
                  <span className="text-[13px] text-ink-muted">Custom</span>
                </label>
              </div>
        ...
        <div className="flex items-center gap-2.5 px-6 py-4 border-t border-line">
          <button
            className={cn(
              "h-9 px-3 text-[13px] font-medium rounded-lg border border-transparent cursor-pointer transition-colors duration-150",
              confirmDelete
                ? "bg-err text-act-ink"
                : "bg-err-soft text-err hover:opacity-90",
