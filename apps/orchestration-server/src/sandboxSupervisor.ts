...
let structured; try{structured=JSON.parse(structuredText.trim())}catch{structured={schema:"factory-result/v1",status:"FAILED",summary:"Executor did not return factory-result/v1 JSON.",completedAcceptanceCriterionIds:[],incompleteAcceptanceCriterionIds:[],unknownAcceptanceCriterionIds:[],verificationCommands:[],knownRisks:[stderr.slice(-1000)],nextAction:"Inspect executor evidence."}}
