...
describe("factory documentation consistency", () => {
  ...
  it("rejects runtime-version and maturity-plan drift", () => {
    ...
    writeFileSync(readmePath, readFileSync(readmePath, "utf8").replace("runtime contract is **v32**", "runtime contract is **v31**"));
    ...
    expect(result.findings).toContain("README.md: runtime contract v31 does not match source v32");
